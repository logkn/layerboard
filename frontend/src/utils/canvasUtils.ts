...
export function calculateConnectionPoints(
    ...
    const sourceIntersection = getNodeIntersection(sourceNode, dirX, dirY)

    // Target node intersection (reverse direction)
    const targetIntersection = getNodeIntersection(targetNode, -dirX, -dirY)
 ...
 */
function getNodeIntersection(node: Node, dirX: number, dirY: number): NodePosition {
    const nodeCenter = {
